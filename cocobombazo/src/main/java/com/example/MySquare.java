...
public class MySquare extends Rectangle {
    ...
    public MySquare(){
        ...
        setOnMouseClicked(e -> {
            ...
            if (e.getButton() == MouseButton.SECONDARY && isClicked == false){
                if (rClickType == 1)
                {
                    setFill(new ImagePattern(new Image(getResource("/pics/palma2.png"))));
                    rClickType = 2;
                } 
                ...
                {
                    setFill(new ImagePattern(new Image(getResource("/pics/palma.png"))));
                    rClickType = 1;
                }
            }
        });
    ...
    public void setBomb(){
        setFill(new ImagePattern(new Image(getResource("/pics/Kokos.png"))));
    }
    
    public void setImageNb(int nb){
        if (nb > 0 && nb <= 8)
            setFill(new ImagePattern(new Image(getResource("/pics/" + Integer.toString(nb) + ".png"))));
